...
Global FTP_Port=21
Global UM_Data_File.s="IG_Data.dat"
...
Procedure Get_Database()
  ...
  Protected Data_File.s="IG_Data.dat"
...
Procedure Draw_List()
  ...
  ForEach Filtered_List()
    ...
    If Output_Case=2
      Text=UCase(Text)
    EndIf
    Text+File+Chr(10)+UM_Database()\UM_Path+Chr(10)+UM_Database()\UM_Genre
...
; DPIAware
; UseIcon = boing.ico
; Executable = TinyLauncher_Tool.exe
...
; VersionField2 = MrV2K
; VersionField3 = Tinylauncher Tool
; VersionField4 = 0.2 Alpha
; VersionField5 = 0.2 Alpha
; VersionField6 = Tinylauncher Conversion Tool
; VersionField7 = Tinylauncher_Tool
; VersionField8 = Tinylauncher_Tool.exe
